...
public class R040_SwitchScan {
    ...
    ```Other than these four names if the user provides any other names --> " Invalid instructor selected"   */
        ...
        switch (name) { // this is enhanced switch
            case "Asghar" -> System.out.println("Will take care of Java Assignment");
            case "Moazzam" -> System.out.println("Will take care of SDLC Assignment");
