...
public class R041_SwitchScan {
    public static void main(String[] args) {
        /* Write a program using the switch statement.  Let us consider the scenario regarding the born baby age
        First Output: "Enter the age of the Child"      case 1: if age is 1 print as "You can Crawl"
        ...
        switch (age) {
            ...
            case 3 -> System.out.println("You can Dance");
            case 4 -> System.out.println("You can get Trouble");
